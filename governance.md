...
description: "Mission, trustees, policies and finances for Project Possibility, registered charity no. 1205365."
---
...
<section class="page-hero">
  <div class="wrap">
    ...
    <h1>Governance</h1>
    <p>Who we are, how we're run, and how we look after the money people trust us with.</p>
  </div>
</section>
...
<section class="section-white">
  <div class="wrap">
    <div class="mission-statement">
      ...
      <p>We run inspiring events that combine science, technology, and the arts, and we build them
...
<div class="govern-grid" markdown="1">
<div class="govern-card" markdown="1">
### What we do
Education and training. Economic, community development and employment. Human rights, equality and diversity.
</div>
<div class="govern-card" markdown="1">
### Who we help
Children and young people. People with disabilities. Other charities and voluntary bodies. The general public.
</div>
<div class="govern-card" markdown="1">
### How we help
By providing services, and by providing advocacy, advice and information.
</div>
<div class="govern-card" markdown="1">
### Where we work
...
Trustees are responsible for controlling the work, management and administration of the charity. Ours are:
...
The charity holds the following policies, reviewed by the trustees:
...
<address class="reg-details">
  <strong>Project Possibility</strong><br>
  Registered charity no. {{ site.charity_number }} (England and Wales)<br>
  Charitable Incorporated Organisation<br>
  Milton Keynes, Buckinghamshire, United Kingdom<br>
